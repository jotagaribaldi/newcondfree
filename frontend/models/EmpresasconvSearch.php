...
use frontend\models\Empresasconv;
...
class EmpresasconvSearch extends Empresasconv
{
    ...
    public function rules()
    {
        return [
            ...
            [['razaosocial', 'nomefantasia', 'segmento', 'CEP', 'endereco_parc', 'complem_parc', 'num_ender_emp', 'bairro_emp', 'doc_empresa', 'fonefixo_emp', 'fonecel_emp', 'email_emp', 'link_instag', 'link_facebook', 'logo_empresa', 'termo_digital', 'datahoracad_emp', 'ip_register_emp'], 'safe'],
            [['percent_cash'], 'number'],
        ];
    }
